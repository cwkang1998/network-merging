...
def concat_naive(args, model1, model2, device, test_loader):
    """
...
def concat_std(args, model1, model2, device, test_loader):
    model1.eval()
    model2.eval()
    test_loss = 0
    correct = 0
...
def concat_ratio(args, model1, model2, device, test_loader):
    model1.eval()
    model2.eval()
    test_loss = 0
    correct = 0
...
def concat_overall_ratio(args, model1, model2, device, test_loader):
    model1.eval()
    model2.eval()
    test_loss = 0
    correct = 0
...
def concat_thirdQ(args, model1, model2, device, test_loader):
    model1.eval()
    model2.eval()
    test_loss = 0
    correct = 0
