...
def predict_with_logits_pan(args, model1, model2, pan1, pan2, m1_data, m2_data):
    """
...
def predict_with_agnostic_pan(args, model1, model2, pan1, pan2, m1_data, m2_data):
    """
...
def smart_coord_test(args, model1, model2, pan1, pan2, device, test_loaders):
    model1.eval()
    model2.eval()
    pan1.eval()
    pan2.eval()
        ...
        for m1_data, m2_data, target in test_loader:
            ...
            if args.pan_type == "feature":
                output = predict_with_feature_pan(
                    args, model1, model2, pan1, pan2, m1_data, m2_data
                )
                ...
                args.pan_type == "agnostic_feature"
                or args.pan_type == "agnostic_logits"
            ):
